...
export default async function Home() {
  ...
  return (
    <main className="relative min-h-screen overflow-hidden px-6 py-5 sm:px-8 sm:py-8">
      ...
      <div className="relative z-10 mx-auto flex min-h-[calc(100vh-2.5rem)] w-full max-w-4xl flex-col sm:min-h-[calc(100vh-4rem)]">
        ...
        <section className="flex flex-1 flex-col items-center justify-center pb-8 pt-6 text-center sm:pb-12">
          ...
          <div className="mt-7 max-w-3xl">
            ...
            <p className="layer-reveal layer-copy mx-auto mt-5 max-w-2xl text-base leading-8 text-muted">
              I am Rashad Isayev, a developer creating practical web
              experiences, learning resources, and tools that turn ideas into
              durable products.
            </p>
          </div>
          ...
          <div className="layer-reveal layer-actions mt-7 flex w-full flex-col items-center justify-center gap-3 sm:w-auto sm:flex-row">
            <Button asChild variant="outline" className="w-full sm:w-auto">
              <Link href="https://github.com/rashadisayev" target="_blank">
                <ExternalLink aria-hidden="true" className="size-4" />
                See my GitHub
              </Link>
            </Button>
            <Button asChild className="w-full sm:w-auto">
              <Link href="mailto:hello@rashadisayev.com">
