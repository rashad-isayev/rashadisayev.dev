      ...
      {!configured ? (
        ...
        >
          ...
          <div>
            ...
            <div className="admin-input-wrap mt-2 flex rounded-md border border-border bg-background/50 px-3 focus-within:border-accent/80 focus-within:bg-background/70">
